    ...
    <div class="space-y-space-lg">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-space-lg">
            @foreach ([
                    ...
                    @else
                        <ul class="divide-y divide-outline-variant">
                            @foreach ($group['categories'] as $category)
                                ...
                                <!-- Edit Category Modal -->
                                <x-modal id="edit-category-modal-{{ $category->id }}" title="Edit Category">
                                ...
                                <x-modal id="delete-category-modal-{{ $category->id }}" title="Delete Category">
                ...
                <!-- Add Category Modal -->
                <x-modal id="add-category-modal-{{ $type }}" title="Add {{ $group['title'] }} Category">
